<?php namespace Nls\LaravelDoctrine;
...
class LaravelDoctrineServiceProvider extends Base {
	...
	public function boot() {
		$this->package('nls/laravel-doctrine');
	}
	...
	public function register() {
		...
		//
		$this->commands(
			array('Nls\LaravelDoctrine\Console\CreateSchemaCommand',
			'Nls\LaravelDoctrine\Console\UpdateSchemaCommand',
			'Nls\LaravelDoctrine\Console\DropSchemaCommand')
		);
